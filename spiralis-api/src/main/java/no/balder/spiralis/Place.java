...
public class Place {
    ...
    /** Name of queue from which new transport requests are obtained */
    ...
    /** Name of queue holding transport requests ready to be transmitted into the PEPPOL network */
    public static final Place OUTBOUND_TRANSMISSION = new Place("Outbound.transport");

    public static final Place OUTBOUND_TRANSMISSION_ERROR = new Place("Outbound.transport.error");
