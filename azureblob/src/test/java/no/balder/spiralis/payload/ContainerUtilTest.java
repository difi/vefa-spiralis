...
public class ContainerUtilTest {
    ...
    public void testContainerName() throws Exception {
        ...
        assertEquals(containerNameForPayload, "peppol-ap-01");

        final String smime = ContainerUtil.containerNameFor(Paths.get("/var/peppol/IN/9908_971589671/9908_848382922/2017-01-10/17524837-551a-4316-b3a3-feb9ebd84ac0-rcpt.smime"));
        assertEquals(containerNameForPayload, smime);
